...
public class SseEndpointProcessor extends EndpointProcessor {
	...
	public SseEndpointProcessor(String prefixValue, TypeElement type, VariableElement field, Sse sse, TypeName object, MethodInfo method) {
		...
		DagNode<VariableInit> message = DagNode.of(new ConsumerProvider(
				"message",
				CodeBlock.of("$T.$L.register", type, field.getSimpleName()),
				exchange.value
		), exchange);
